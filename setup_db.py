...
def init_posts(conn):
    init = [(1, "Optimal Drift for Lavere Strømkostnader", "energi_1.jpeg", "Denne grafen viser en optimal plan for å minimere elektrisitetskostnadene ved å slå på maskinen i de billigste timene. De grå søylene representerer strømprisen per time, mens de grønne søylene indikerer hvilke timer maskinen bør være på for å redusere kostnadene. Målet er å unngå drift i perioder med høye priser og prioritere drift når strømmen er billigst. Dette kan bidra til betydelige besparelser i energiforbruk og driftskostnader.", "Strømkostnader", "2025-02-15", 1),
